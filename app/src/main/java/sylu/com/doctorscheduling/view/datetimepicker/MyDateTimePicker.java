package sylu.com.doctorscheduling.view.datetimepicker;
...
/**
 * Created by Hudsvi on 2017/3/10 12:55.
 */


public class MyDateTimePicker {
    /**
     * 定义结果回调接口,showSpecificTime(false)用于隐藏时和分
     */
...
* startDate是可供选择的开始时间，
* endDate是最大时间，可以设置为将来某个日期和时间。
* resultHander参数：可以通过new MyDateTimePicker.ResultHandler()获得,一个回调接口
* setIsLoop(false)方法用来设置是否滚动
*/
    public MyDateTimePicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initView() {
        year_pv = (DatePickerView) datePickerDialog.findViewById(R.id.date_year);
        month_pv = (DatePickerView) datePickerDialog.findViewById(R.id.date_month);
        day_pv = (DatePickerView) datePickerDialog.findViewById(R.id.date_day);
        hour_pv = (DatePickerView) datePickerDialog.findViewById(R.id.date_hour);
        minute_pv = (DatePickerView) datePickerDialog.findViewById(R.id.date_minute);
        tv_cancle = (TextView) datePickerDialog.findViewById(R.id.date_cancel);
        tv_select = (TextView) datePickerDialog.findViewById(R.id.date_confirm);
        hour_text = (TextView) datePickerDialog.findViewById(R.id.tv_hour);
        minute_text = (TextView) datePickerDialog.findViewById(R.id.tv_minute);
